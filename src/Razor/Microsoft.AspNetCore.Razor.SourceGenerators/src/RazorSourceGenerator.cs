...
namespace Microsoft.AspNetCore.Razor.SourceGenerators
{
    ...
    public partial class RazorSourceGenerator : ISourceGenerator
    {
        ...
        {
            System.Console.WriteLine("Inside SourceGenerator execute...");
            ...
            var projectEngine = RazorProjectEngine.Create(razorContext.Configuration, razorContext.FileSystem, b =>
            {
                ...
                // {
                //     b.Features.Add(new ConfigureRazorCodeGenerationOptions(options => options));
                // }
        ...
        {
            System.Console.WriteLine("Generating for CSHTML files...");
